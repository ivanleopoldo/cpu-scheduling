    ...
    def completion_time(self):
        ...
        while sorted_processes:
            ...
            if available_processes:
                current_process = min(available_processes, key=lambda x: x["prio"])
...
if __name__ == "__main__":
    ...
    psnp = PrioritySchedulingNP(processes)

    completion_time = psnp.completion_time()
    avg_tat = psnp.turnaround_time()
    avg_wt = psnp.waiting_time()
    cpu_usage = psnp.cpu_usage()
    psnp.display_gantt_chart()
